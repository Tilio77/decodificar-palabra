...
// Función para desordenar las palabras. Quedaran guardadas en el arreglo desordenadas
...
function siguiente() {
  // Asi limpio los arreglos palabras y desordenadas, para cargarlo con las nuevas palabras
  palabras.length = 0;
